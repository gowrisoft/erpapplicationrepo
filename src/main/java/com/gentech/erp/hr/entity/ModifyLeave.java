...
public class ModifyLeave {
    ...
    public ModifyLeave(int modifyLeaveId, String empName, Date modifiedDate, Date newStartDate, Date newEndDate, String newLeaveType, String newReason, Employee employee, LeaveApplication leaveApplication) {
