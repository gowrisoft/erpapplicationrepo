...
public class ModifyLeaveDto {
    ...
    public ModifyLeaveDto(int modifyLeaveId, String empName, Date modifiedDate, Date newStartDate, Date newEndDate, String newLeaveType, String newReason, long empId, int leaveRequestId) {
